...
<h3>Passwort &auml;ndern</h3> <!-- 3. Text "Sonderfunktion" gelöscht  -->
<table>
...
$body='Schade, dass du deinen Account bei HTN.LAN löschen möchtest!'.LF."\n";
...
case 'newpwd': //------------------------- NEW PWD -------------------------------
#if($usr['stat']<10) { simple_message('No!'); exit; } // 1. Auskommentiert damit jeder Passwort ändern kann
$pwd=$_POST['pwd'];
...
case 'adminaufgaben': //4. Subnetze füllen code
    if ($usr['stat']>100) { 
