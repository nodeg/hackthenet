...
#HTN.Lan Einstellungen
define('geschwindigkeit',20,false); #Geschwindigkeit des Spieles Standart: 10;
define('startgeld',25000,false); #Startgeld für neue PC's
...
$account_activation_per_email = true; // Account-Freischaltung per Email ?
$enable_visual_confirmation = true; // Anti-Bot-Bildchen?
...
$stylesheets['standard'] = array('id'=>'standard', 'name'=>'HackTheNet Standard', 'author'=>'HackTheNet-Team', 'bigacc'=>'yes');
$stylesheets['crystal'] = array('id'=>'crystal', 'name'=>'HackTheNet Crystal', 'author'=>'HackTheNet-Team', 'bigacc'=>'no');
$stylesheets['crystal-old'] = array('id'=>'crystal', 'name'=>'HackTheNet Crystal', 'author'=>'BODY-SNATCHER', 'bigacc'=>'no');
...
$stylesheets['modern'] = array('id'=>'modern', 'name'=>'Modern', 'author'=>'Volkmar und xXxUnKnownxXx', 'bigacc'=>'yes');
